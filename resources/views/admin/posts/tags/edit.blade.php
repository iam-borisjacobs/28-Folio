...
<div class="py-6">
    <div class="w-full">
        ...
        <div class="flex flex-col mb-8">
            <h1 class="text-5xl font-bold text-white mb-4">Edit Tag</h1>
            <nav class="flex text-gray-400 text-lg">
                ...
                <span class="mx-3">&rsaquo;</span>
                <a href="{{ route('admin.posts.tags.index') }}" class="hover:text-white transition-colors">Tags</a>
                <span class="mx-3">&rsaquo;</span>
                <span class="text-gray-500">Edit Tag</span>
            </nav>
        </div>

        <div class="bg-gray-800 rounded-2xl shadow-xl overflow-hidden border border-gray-700 max-w-4xl">
            <form action="{{ route('admin.posts.tags.update', $tag) }}" method="POST" class="p-8 space-y-8">
                @csrf
                @method('PUT')
                ...
                <div class="flex justify-end space-x-4 pt-6 border-t border-gray-700">
                    <a href="{{ route('admin.posts.tags.index') }}" class="inline-flex items-center px-6 py-3 border border-gray-600 rounded-lg shadow-sm text-sm font-medium text-gray-300 bg-transparent hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 focus:ring-offset-gray-900 transition-colors">
                        Cancel
                    </a>
