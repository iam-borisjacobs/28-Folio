    ...
    <div class="w-full px-6">
        ...
        <div class="flex flex-col mb-8">
            ...
            <nav class="flex text-gray-400 text-lg">
                ...
                <span class="mx-3">&rsaquo;</span>
                <a href="{{ route('admin.projects.tags.index') }}" class="hover:text-white transition-colors">Tags</a>
                <span class="mx-3">&rsaquo;</span>
        ...
        <div class="bg-[#1e293b] rounded-lg shadow-xl overflow-hidden border border-gray-700 max-w-4xl">
            <form action="{{ route('admin.projects.tags.update', $tag) }}" method="POST" class="p-8 space-y-8">
                @csrf
                @method('PUT')
                ...
                <div class="flex justify-end space-x-4 pt-4 border-t border-gray-700">
                    <a href="{{ route('admin.projects.tags.index') }}" class="inline-flex items-center px-8 py-4 bg-gray-700 border border-transparent rounded-md font-bold text-sm text-white uppercase tracking-widest hover:bg-gray-600 focus:bg-gray-600 active:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150">
                        {{ __('Cancel') }}
                    </a>
