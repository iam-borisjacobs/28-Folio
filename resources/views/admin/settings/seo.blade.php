        ...
        <form action="{{ route('admin.settings.seo') }}" method="POST">
            ...
            <div class="bg-[#1e293b] rounded-lg shadow-xl overflow-hidden border border-gray-700 mb-8">
                <div class="p-8 space-y-8">
                    ...
                    <div>
                        <label for="meta_title_format" class="block text-lg font-medium text-gray-300 mb-3">Meta Title Format</label>
                        <input type="text" name="meta_title_format" id="meta_title_format" value="{{ old('meta_title_format', $settings['meta_title_format'] ?? '%page% | %site%') }}" 
                        ...
                        <p class="mt-2 text-base text-gray-500">Variables: <code>%page%</code>, <code>%site%</code>, <code>%tagline%</code></p>
                    </div>

                    <div>
                        <label for="meta_description_default" class="block text-lg font-medium text-gray-300 mb-3">Default Meta Description</label>
                    ...
                    <div class="flex items-center pt-4">
                            ...
                            <input type="checkbox" name="allow_indexing" id="allow_indexing" value="1" {{ ($settings['allow_indexing'] ?? '0') == '1' ? 'checked' : '' }} class="h-6 w-6 text-indigo-600 focus:ring-indigo-500 border-gray-700 bg-gray-900 rounded">
            ...
            <div class="bg-[#1e293b] rounded-lg shadow-xl overflow-hidden border border-gray-700">
                 <div class="p-8 space-y-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div>
                            <label for="social_twitter" class="block text-lg font-medium text-gray-300 mb-3">Twitter Handle</label>
                            <div class="mt-1 flex rounded-md shadow-sm">
                                <span class="inline-flex items-center px-4 rounded-l-md border border-r-0 border-gray-700 bg-gray-800 text-gray-300 text-lg">@</span>
                                <input type="text" name="social_twitter" id="social_twitter" value="{{ old('social_twitter', $settings['social_twitter'] ?? '') }}" 
                        ...
                        <div>
                            <label for="social_instagram" class="block text-lg font-medium text-gray-300 mb-3">Instagram</label>
                            <input type="text" name="social_instagram" id="social_instagram" value="{{ old('social_instagram', $settings['social_instagram'] ?? '') }}" 
                                class="block w-full rounded-md border-gray-700 bg-gray-900 text-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-lg px-5 py-4">
                        </div>
                            <div>
                            <label for="social_linkedin" class="block text-lg font-medium text-gray-300 mb-3">LinkedIn URL</label>
                            <input type="text" name="social_linkedin" id="social_linkedin" value="{{ old('social_linkedin', $settings['social_linkedin'] ?? '') }}" 
                                class="block w-full rounded-md border-gray-700 bg-gray-900 text-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-lg px-5 py-4">
                        </div>
                            <div>
                            <label for="social_github" class="block text-lg font-medium text-gray-300 mb-3">GitHub URL</label>
                            <input type="text" name="social_github" id="social_github" value="{{ old('social_github', $settings['social_github'] ?? '') }}" 
                                class="block w-full rounded-md border-gray-700 bg-gray-900 text-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-lg px-5 py-4">
                        </div>
                    </div>
                </div>
