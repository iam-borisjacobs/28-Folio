...
<div class="py-6">
    <div class="w-full px-6">
        ...
        <div class="flex flex-col mb-8">
            <h1 class="text-5xl font-bold text-white mb-4">Add Language</h1>
            ...
            <form action="{{ route('admin.settings.languages.store') }}" method="POST">
                ...
                <div class="p-8 space-y-8">
                    ...
                    <div>
                        ...
                        <input type="text" name="name" value="{{ old('name') }}" class="w-full bg-gray-900 border border-gray-700 rounded-lg px-4 py-3 text-white focus:ring-2 focus:ring-indigo-500 focus:border-transparent" placeholder="e.g. French" required>
                        @error('name')
                    ...
                    <div>
                        ...
                        <input type="text" name="code" value="{{ old('code') }}" class="w-full bg-gray-900 border border-gray-700 rounded-lg px-4 py-3 text-white focus:ring-2 focus:ring-indigo-500 focus:border-transparent" placeholder="e.g. fr" maxlength="2" required>
                    ...
                    <div>
                        ...
                        <input type="number" name="sort_order" value="{{ old('sort_order', 0) }}" class="w-full bg-gray-900 border border-gray-700 rounded-lg px-4 py-3 text-white focus:ring-2 focus:ring-indigo-500 focus:border-transparent">
                    </div>

                    <!-- Flags -->
                    <div class="space-y-4">
                        <div class="flex items-center">
                            <input type="checkbox" id="is_active" name="is_active" value="1" {{ old('is_active', true) ? 'checked' : '' }} class="h-6 w-6 text-indigo-600 focus:ring-indigo-500 border-gray-700 rounded bg-gray-900">
                            <label for="is_active" class="ml-3 block text-lg font-medium text-gray-300">Active</label>
                        </div>
                        
                        <div class="flex items-center">
                            <input type="checkbox" id="is_default" name="is_default" value="1" {{ old('is_default') ? 'checked' : '' }} class="h-6 w-6 text-indigo-600 focus:ring-indigo-500 border-gray-700 rounded bg-gray-900">
