...
<div class="py-6">
    <div class="w-full px-6">
        ...
        <div class="flex flex-col mb-8">
            <h1 class="text-5xl font-bold text-white mb-4">Edit Award</h1>
        ...
        <div class="bg-[#1e293b] rounded-lg shadow-xl overflow-hidden border border-gray-700">
            <form action="{{ route('admin.resume.awards.update', $award) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="p-8 space-y-8">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div class="col-span-1">
                            ...
                            <input type="text" id="title" name="title" value="{{ old('title', $award->title) }}" required autofocus
                         ...
                         <div class="col-span-1">
                            ...
                            <input type="text" id="issuer" name="issuer" value="{{ old('issuer', $award->issuer) }}" required
                                class="block w-full rounded-md border-gray-700 bg-gray-900 text-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-lg px-5 py-4"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
                         ...
                         <div class="col-span-1">
                            ...
                            <input type="date" id="award_date" name="award_date" value="{{ old('award_date', $award->award_date ? $award->award_date->format('Y-m-d') : '') }}" required
                                class="block w-full rounded-md border-gray-700 bg-gray-900 text-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-lg px-5 py-4">
                        ...
                        <div class="col-span-1">
                            ...
                            <input type="number" id="sort_order" name="sort_order" value="{{ old('sort_order', $award->sort_order) }}"
                    ...
                    <div class="col-span-2">
                        ...
                        <div class="rounded-md border border-gray-700 bg-gray-900 overflow-hidden">
                            <textarea id="description" name="description" rows="4"
                                ...
                                placeholder="Brief description of the award...">{{ old('description', $award->description) }}</textarea>
                        </div>
