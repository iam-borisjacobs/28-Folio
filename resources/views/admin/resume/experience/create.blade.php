...
<div class="py-6">
    <div class="w-full px-6">
        ...
        <div class="flex flex-col mb-8">
            <h1 class="text-5xl font-bold text-white mb-4">Add Experience</h1>
        ...
        <div class="bg-[#1e293b] rounded-lg shadow-xl overflow-hidden border border-gray-700">
            <form action="{{ route('admin.resume.experience.store') }}" method="POST" x-data="{ isCurrent: {{ old('is_current', 'false') }} }">
                @csrf
                ...
                <div class="p-8 space-y-8">
                    ...
                    <div>
                        ...
                        <p class="mt-2 text-base text-gray-500">Supports simple text. For rich text, we can enable markdown later.</p>
