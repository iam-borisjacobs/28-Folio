...
<div class="py-6">
    <div class="w-full px-6">
        ...
        <div class="flex flex-col mb-8">
            <h1 class="text-5xl font-bold text-white mb-4">Edit Education</h1>
        ...
        <div class="bg-[#1e293b] rounded-lg shadow-xl overflow-hidden border border-gray-700">
            <form action="{{ route('admin.resume.education.update', $education) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="p-8 space-y-8">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div class="col-span-1">
                            ...
                            <input type="text" id="institution" name="institution" value="{{ old('institution', $education->institution) }}" required autofocus
                    ...
                    <div>
                        ...
                        <div class="rounded-md border border-gray-700 bg-gray-900 overflow-hidden">
                            <textarea id="description" name="description" rows="4"
                                ...
                                placeholder="Activities, societies, etc...">{{ old('description', $education->description) }}</textarea>
                        </div>
                    ...
                    <div>
                        ...
                        <input type="number" id="sort_order" name="sort_order" value="{{ old('sort_order', $education->sort_order) }}"
