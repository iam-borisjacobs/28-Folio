...
<div class="py-6">
    <div class="w-full px-6">
        ...
        <div class="flex flex-col mb-8">
            <h1 class="text-5xl font-bold text-white mb-4">Add Skill</h1>
        ...
        <div class="bg-[#1e293b] rounded-lg shadow-xl overflow-hidden border border-gray-700" x-data="{ proficiency: {{ old('proficiency', 50) }} }">
            <form action="{{ route('admin.resume.skills.store') }}" method="POST">
                @csrf
