<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-8">
        ...
        <div>
            <label for="name" class="block text-lg font-medium text-gray-300 mb-3">{{ __('Name') }}</label>
        ...
        <div>
            <label for="email" class="block text-lg font-medium text-gray-300 mb-3">{{ __('Email') }}</label>
